				...
				<v-card-text>
					<v-container>
						<v-form ref="newUser">
							...
							<v-row>
								<v-col cols="12" md="6">
									<v-text-field dense label="Username" @keydown="resetUsernameError" v-model="state.user.username" :error="state.rules.username.error.status" :error-messages="state.rules.username.error.message" :rules="state.rules.username.required" required />
								</v-col>
								<v-col cols="12" md="6">
